###################################
# PYTHON İLE VERİ ANALİZİNE GİRİŞ (DATA ANALYSIS WITH PYTHON)
###################################
# - NUMPY
# - PANDAS
...
#Veri görselleştirmede matplotlib low-level, seaborn high-level'dır.
#Büyük ölçekli bir problem geldiğinde bunun fonksiyonel bir biçimde nasıl geliştirileceğine değinilecek.


#Bu kütüphaneleri kullanarak giriş seviyesindeki bazı problemleri çözümlemek oldukça kolaydır.
#Ama gerçeek hayat problemleri ele alındığında yüz yüze kalacak olduğumuz veri setlerinin noyutları
# ve bu veri setleri ile ölçeklenebilir bir şekilde çalışabilmek başka bir problemdir.

#Son modülde büyük ölçekli problemler için kitaplarda yer almayan özel çözümler geliştirilmiştir.
